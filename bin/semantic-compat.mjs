...
// The Phase 9–25 compatibility cone is a versioned file manifest. It is
...
function loadManifest() {
  ...
  if (manifest.requiredPhaseRange?.first !== 9 || manifest.requiredPhaseRange?.last !== 25) fail('SEMANTIC_COMPATIBILITY_PHASE_RANGE_INVALID');
