    ...
    const files = group.commandKey === 'SEMANTIC_COMPATIBILITY'
      ...
      : group.commandKey === 'OWNER_PROVENANCE'
        ...
        : group.commandKey === 'SYNTHETIC_CAMPAIGN'
          ? ['tests/unit/campaign.test.ts', 'tests/unit/phase24SyntheticCampaign.test.ts', 'tests/unit/phase25SyntheticCampaign.test.ts', 'tests/unit/phase26SyntheticCampaign.test.ts', 'tests/unit/phase27ResponseFlow.test.ts', 'tests/unit/phase28SourceIntelligence.test.ts', 'tests/unit/responseFlowBindingHardening.test.ts']
          : [];
    return {
      groupId: group.id,
