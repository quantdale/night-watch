...
test.describe('Phase 8B adopted-case catalog', () => {
  test('canonical catalog starts empty and produces zero baseline seeding', () => {
    expect(SELFDEV_ADOPTED_CASES).toEqual([]);
    expect(selfDevAdoptedEquivalentFingerprints()).toEqual([]);
