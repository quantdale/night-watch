...
at the next checkpoint. Keep STATE concise; move durable history to REPORT or
project docs. Never let a plan preserve a known-wrong assumption for the sake
of consistency.
