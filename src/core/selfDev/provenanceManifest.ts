...
export const SELFDEV_AUTHORITATIVE_PATHS = Object.freeze([
  ...
  'bin/selfdev-promote-canonical.mjs',
  'src/core/selfDevPromotion/apply.ts',
  'src/core/selfDevPromotion/approve.ts',
  'src/core/selfDevPromotion/currentness.ts',
  'src/core/selfDevPromotion/index.ts',
  'src/core/selfDevPromotion/prepare.ts',
  'src/core/selfDevPromotion/storage.ts',
  'src/core/selfDevPromotion/types.ts',
  'src/core/selfDevPromotion/validation.ts',
  'src/core/selfDevPromotion/verify.ts',
  'tsconfig.json',
] as const);
