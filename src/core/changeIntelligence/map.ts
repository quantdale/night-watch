...
export const RIPPLE_REPOSITORIES: readonly RepoDefinition[] = [
  ...
  // C-05 repository admissions. Both are owner-named, and the admitted set is
  // limited to these two — discovery saw 149 repositories under the sibling
  // root and that grants nothing. The pinned SHAs are the revisions the
  // admission was measured against, not live observations.
  {
    repoId: 'alphauslabs/blueinternal',
    productRole: 'Internal Alphaus API surface; committed generated OpenAPI artifact',
    scope: 'IN_SCOPE',
    checkedOutSha: 'bc629fa8adc9f5407a2b957bd1b2aecdc8b0d623',
    trackingRef: 'origin/main',
    sourceMapSha: 'bc629fa8adc9f5407a2b957bd1b2aecdc8b0d623',
    readOnlyOnly: true,
  },
  {
    repoId: 'mobingilabs/wave-api',
    productRole: 'Legacy Wave PHP API; same route/handler architecture as ripple-api',
    scope: 'IN_SCOPE',
    checkedOutSha: '46790c25ddea02c7d3ae65f6e6db766a9089a59f',
    trackingRef: 'origin/master',
    sourceMapSha: '46790c25ddea02c7d3ae65f6e6db766a9089a59f',
    readOnlyOnly: true,
  },
];
