...
- [x] 1.1 Verify baseline, canonical cleanliness, and C-00 topology.
- [x] 1.2 Resolve only the owner-attested formatter/editor-churn file.
- [x] 1.3 Recover the retained discovery checkpoint without blind integration.
- [x] 1.4 Revalidate six provisional findings and reproduce A/B integrity cases.
