...
#### Scenario: evidence-ranked remediation
...
#### Scenario: authority-chain integrity
...
#### Scenario: process-level containment truth
...
#### Scenario: safety-test retry authority
...
#### Scenario: clean reproducibility
...
#### Scenario: fail-closed safety preservation
...
The release certification SHALL require all applicable final checks to pass.
...
#### Scenario: truthful terminal state
