...
This is primarily a hardening and certification campaign. It may include implementation repairs when fresh evidence discovers defects, but it must not invent new product scope or loosen fail-closed proof rules to create apparent progress.
...
- browser/proxy/environment safety boundaries;
...
- test coverage, skipped-test disposition and failure paths;
...
3. `PROJECT_NOT_COMPLETE_BLOCKED` — a concrete P0/P1 or required validation remains unresolved; report exact blocker and reproducible evidence.
